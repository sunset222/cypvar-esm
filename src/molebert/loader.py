...
class MoleculeDataset(InMemoryDataset):
    ...
    def process(self):
        ...
        elif self.dataset == 'cyp_substrate':
            smiles_list, rdkit_mol_objs, labels = \
                _load_cyp_subs_dataset(self.raw_paths[0])
            for i in range(len(smiles_list)):
                print(i)
                rdkit_mol = rdkit_mol_objs[i]
                ## convert aromatic bonds to double bonds
        ...
        elif self.dataset == 'cyp':
            smiles_list, rdkit_mol_objs, labels = \
                _load_cyp_dataset(self.raw_paths[0])
            for i in range(len(smiles_list)):
                print(i)
                rdkit_mol = rdkit_mol_objs[i]
                ## convert aromatic bonds to double bonds
        ...
        elif self.dataset == 'cyp_merged':
            smiles_list, rdkit_mol_objs, labels = \
                _load_cyp_merged_dataset(self.raw_paths[0])
            for i in range(len(smiles_list)):
                print(i)
                rdkit_mol = rdkit_mol_objs[i]
                ## convert aromatic bonds to double bonds
        ...
        elif self.dataset == 'cyp_soft':
            smiles_list, rdkit_mol_objs, labels = \
                _load_cyp_soft_dataset(self.raw_paths[0])
            for i in range(len(smiles_list)):
                print(i)
                rdkit_mol = rdkit_mol_objs[i]
                ## convert aromatic bonds to double bonds
...
def _load_cyp_2d6_dataset(input_path):
    """
    ...
    smiles_list = input_df['smiles']
    rdkit_mol_objs_list = [AllChem.MolFromSmiles(s) for s in smiles_list]
    #tasks = ['CYP3A4', 'CYP2C19', 'CYP2D6', 'CYP1A2', 'CYP2A6',  'CYP2E1', 'CYP2C8', 'CYP2B6','CYP2C9']
    tasks = ['CYP2D6_sub']#['CYP2D6_inhib']# + ['CYP2D6_sub']
    labels = input_df[tasks]
    # convert 0 to -1
    labels = labels.replace(0, -1)
    # convert nan to 0
...
def _load_cyp_merged_dataset(input_path):
    """
    ...
    rdkit_mol_objs_list = [AllChem.MolFromSmiles(s) for s in smiles_list]
    #tasks = ['CYP3A4', 'CYP2C19', 'CYP2D6', 'CYP1A2', 'CYP2A6',  'CYP2E1', 'CYP2C8', 'CYP2B6','CYP2C9']
    tasks = ['CYP3A4_inhib', 'CYP2C19_inhib', 'CYP2D6_inhib', 'CYP1A2_inhib','CYP2C9_inhib'] + ['CYP3A4_sub', 'CYP2C19_sub', 'CYP2D6_sub', 'CYP1A2_sub', 'CYP2A6_sub',  'CYP2E1_sub', 'CYP2C8_sub', 'CYP2B6_sub','CYP2C9_sub'] + ['HLM', 'RLM']
    labels = input_df[tasks]
    # convert 0 to -1
    labels = labels.replace(0, -1)
    # convert nan to 0
...
def _load_cyp_soft_dataset(input_path):
    """
...
def _load_cyp_subs_dataset(input_path):
    """
...
def _load_cyp_dataset(input_path):
    """
    ...
    smiles_list = input_df['smiles']
    rdkit_mol_objs_list = [AllChem.MolFromSmiles(s) for s in smiles_list]
    tasks = ['CYP3A4', 'CYP2C19', 'CYP2D6', 'CYP1A2', 'CYP2C9']
